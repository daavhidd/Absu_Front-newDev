...
const NewsPage = (props) => {
  ...
  useEffect(() => {
    ...
    // getMedia();
    // getMainNews();
    console.log(state.passedParam, "new new");
    // setStaffData(props?.location?.state?.data)
    setHtmlContent($(props?.location?.state?.dataPass?.post_content))
        ...
        >
          <div className="container-fluid">
            <div className="container">
              ...
              <td dangerouslySetInnerHTML={{__html: state.passedParam?.post_content}} />
