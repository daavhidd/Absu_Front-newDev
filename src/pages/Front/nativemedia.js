 ...
 const [facultyList, setFacultyList] = useState([]);
  ...
  const getFacultiesDepartments = () => {
    var requestOptions = {
      ...
      fetch('https://portal.abiastateuniversity.edu.ng/api/transcript/FetchFacultyAndDepartment', requestOptions)
        .then(response => {
  ...
  useEffect(() => {
    ...
    // getMedia();
    // getMainNews();
    console.log(facList.ArrayOfFacultyDTO.FacultyDTO)
      ...
      <div className="min-vh-100">
        ...
        >
          <div className="container-fluid">
            <h2 className="monte" style={{ fontSize: "37px" }}>
            ...
            <div className="container">
                {facultyList && facultyList.map((x, i) => {
                    return(
                        <p>
                        {" "}
                        <Link to={{ pathname: "/deptList", state: { data: x } }}>
                          {x.FacultyName}
                        </Link>
                      </p>
                    )
