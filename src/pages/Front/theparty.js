...
<div className="bg-sky" style={isMobile ? { padding: "40px" } : { padding: "63px" }}>
                    <div className="row justify-content-center">
                        ...
                        <div className="col-sm-12 col-lg-10">
                            ...
                            <p style={{ fontSize: "14px" }} className="monte__300">
                            <b style={{fontWeight:"bold"}}>The Peoples Democratic Party</b>, is one of the two major contemporary political parties in Nigeria, along with its main rival, the All Progressives Congress. Its policies generally lie towards the centre-right of the political spectrum.
                            </p>
                        </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(TheParty);
